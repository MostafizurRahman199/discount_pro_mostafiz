...
const UpdateProfile = () => {
    ...
    return (
        ...
        <div className='bg-gradient-to-r from-[#8f5bf6] to-[#a77dfa] p-2 sm:p-4 rounded-2xl shadow-2xl' data-aos='zoom-in-left'>
        <div className="max-w-4xl w-full  bg-white rounded-2xl shadow-lg p-8 flex items-center justify-center gap-2" data-aos='zoom-in-left'>
                <div className="flex-1">
                    <h2 className="text-2xl sm:text-4xl font-bold mb-4 text-[#FED12D]">Update Profile</h2>
                    <form onSubmit={handleUpdate}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#9d73f3]"
                            />
                        </div>
                        <div className="mb-4">
                        ...
                        <button
                            type="submit"
                            className="bg-[#9d73f3] hover:bg-[#FED12D] px-4 py-2 sm:px-8 sm:py-3 rounded-3xl text-white sm:font-semibold transition-transform hover:scale-105 shadow-2xl"
                        >
                            Update Information
                        </button>
                    </form>
